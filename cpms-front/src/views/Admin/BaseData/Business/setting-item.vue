<template>
  ...
  >
    <p-form-model ref="form" :model="tempValue" :rules="rules">
      <p-form-model-item label="机构名称" prop="fdAgencyName">
        <p-input
          v-model="tempValue.fdAgencyName"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
      </p-form-model-item>
      <p-form-model-item label="业务中心名称" prop="fdBusinessName">
        <p-input
          v-model="tempValue.fdBusinessName"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
