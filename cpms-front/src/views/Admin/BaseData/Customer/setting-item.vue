<template>
  ...
  >
    <p-form-model ref="form" :model="tempValue" :rules="rules">
      <p-form-model-item label="客户名称" prop="fdCustomerName">
        <p-input
          v-model="tempValue.fdCustomerName"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
      </p-form-model-item>
      <p-form-model-item label="分公司名称" prop="fdSapCompanyName">
        <p-input
          v-model="tempValue.fdSapCompanyName"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
      </p-form-model-item>
      <p-form-model-item label="销售部名称" prop="fdSaleName">
        <p-input
          v-model="tempValue.fdSaleName"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
