      ...
      <block>
        <template v-slot:title>
          <p-breadcrumb>
            ...
            <p-breadcrumb-item>客户</p-breadcrumb-item>
          </p-breadcrumb>
        </template>
      ...
      <div :class="className" style="margin-top: 16px">
        <p-switch-form :col="3" :model="query">
          <p-switch-form-item label="客户名称">
            <p-input v-model="query.fdCustomerName" placeholder="请输入" />
          </p-switch-form-item>
          <p-switch-form-item label="分公司名称">
            <p-input v-model="query.fdSapCompanyName" placeholder="请输入" />
          </p-switch-form-item>
          <p-switch-form-item label="销售部名称">
            <p-input v-model="query.fdSaleName" placeholder="请输入" />
          </p-switch-form-item>
      ...
      <div :class="className">
        <p-table
          ...
          :columns="[
            ...
            {
              title: '客户名称',
              dataIndex: 'fdCustomerName',
            },
            {
              title: '分公司名称',
              dataIndex: 'fdSapCompanyName',
            },
            {
              title: '销售部名称',
              dataIndex: 'fdSaleName',
            },
            {
              title: '一级渠道',
...
const listMixin = buildListMixin({
  properties: ['fdCustomerName', 'fdSapCompanyName', 'fdSaleName'],
  getQuery: (_, query) => {
    return {
      ...query,
