<template>
  ...
  >
    <p-form-model ref="form" :model="tempValue" :rules="rules">
      <p-form-model-item label="省级" prop="fdProvinceName">
        <p-input
          v-model="tempValue.fdProvinceName"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
      </p-form-model-item>
      <p-form-model-item label="Code" prop="fdProvinceCode">
        <p-input
          v-model="tempValue.fdProvinceCode"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
