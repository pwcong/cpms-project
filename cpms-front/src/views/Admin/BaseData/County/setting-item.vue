<template>
  ...
  >
    <p-form-model ref="form" :model="tempValue" :rules="rules">
      <p-form-model-item label="县区" prop="fdCountyName">
        <p-input
          v-model="tempValue.fdCountyName"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
      </p-form-model-item>
      <p-form-model-item label="Code" prop="fdCountyCode">
        <p-input
          v-model="tempValue.fdCountyCode"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
