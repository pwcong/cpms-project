<template>
  ...
  >
    <p-form-model ref="form" :model="tempValue" :rules="rules">
      <p-form-model-item label="街道" prop="fdStreetName">
        <p-input
          v-model="tempValue.fdStreetName"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
      </p-form-model-item>
      <p-form-model-item label="Code" prop="fdStreetCode">
        <p-input
          v-model="tempValue.fdStreetCode"
          :readOnly="!allowEdit"
          :placeholder="allowEdit ? '请输入' : ''"
          :maxLength="200"
        />
