      ...
      <block>
        <template v-slot:title>
          <p-breadcrumb>
            ...
            <p-breadcrumb-item>市级</p-breadcrumb-item>
          </p-breadcrumb>
        </template>
    ...
    <template v-slot:toolbar="{ className }">
      <div :class="className" style="margin-top: 16px">
        <p-switch-form :col="3" :model="query">
          <p-switch-form-item label="市级">
            <p-input v-model="query.fdCityName" placeholder="请输入" />
          </p-switch-form-item>
      ...
      <div :class="className">
        <p-table
          ...
          :columns="[
            ...
            {
              title: '市级',
              dataIndex: 'fdCityName',
            },
            {
              title: 'Code',
              dataIndex: 'fdCityCode',
            },
