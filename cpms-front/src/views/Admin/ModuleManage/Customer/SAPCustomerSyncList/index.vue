      ...
      <block>
        <template v-slot:title>
          <p-breadcrumb>
            ...
            <p-breadcrumb-item>同步成功客户</p-breadcrumb-item>
          </p-breadcrumb>
        </template>
      </block>
    </template>
      ...
      <div :class="className">
        ...
        >
          ...
          <template slot="operation" slot-scope="text, record">
            <span v-if="record.cpmsCustId">
              <!-- <p-button-link @click="handleDeatil(record)">详情</p-button-link> -->
              <p-button-link @click="handleDeatil(record)">生成记录</p-button-link>
            </span>
          </template>
        </p-table>
      </div>
  ...
  getProperties: (_) => {
    return [
      ...
      },
      {
        ...
        sorter: false,
        hider: true,
        scopedSlots: { customRender: 'firstChannelName' },
      },
      {
        title: '省市县信息',
