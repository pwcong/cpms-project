      ...
      <block>
        <template v-slot:title>
          <p-breadcrumb>
            ...
            <p-breadcrumb-item>周报</p-breadcrumb-item>
          </p-breadcrumb>
        </template>
      </block>
    </template>
...
import SelectWeeklyStatus from '@/views/Salesman/components/select/weekly-status';
...
const listMixin = buildListMixin({
  ...
  getData: (_, query) => {
    return api.salesman.getAllWeekly(query);
  },
});
