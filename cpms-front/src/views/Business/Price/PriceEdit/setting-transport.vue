...
export default {
  ...
  methods: {
    ...
    handleChangeFdCostBearName(res) {
      this.tempValue.fdCostBearCode = (res[0] || {}).value;
      this.tempValue.fdCostBearName = (res[0] || {}).text;
    },
    handleChangeFdTransportTypeName(res) {
      this.tempValue.fdTransportTypeCode = (res[0] || {}).value;
      this.tempValue.fdTransportTypeName = (res[0] || {}).text;
    },
    handleChangeFdPaymentTypeName(res) {
      this.tempValue.fdPaymentTypeCode = (res[0] || {}).value;
      this.tempValue.fdPaymentTypeName = (res[0] || {}).text;
    },
  },
};
</script>
