<template>
  <div>
    <p-row :gutter="[8, 8]">
      <p-col :span="24">
        <block theme="card" style="height: 150px">
          <block>
            <div
              style="
                font-size: 12px;
              ...
              <data-grid
                ...
                :getStyle="
                  () => ({
                    ...
                    title: 'color: #00b050; font-size: 12px',
                  })
                "
                :value="[
                  {
          ...
          <div style="margin-top: 8px">
            ...
            >
              <template>
                ...
                ></clue-state-new>
                <clue-state-aggregate
                  slot="clue-state-aggregate"
                  :reportQuery="reportQuery"
                ></clue-state-aggregate>
              </template>
            </tabs-layout>
...
const reqMixin = buildListMixin({
  ...
  getData: async (_) => {
    const { reportQuery } = _;
    _.timeText = reportQuery.timeText;
