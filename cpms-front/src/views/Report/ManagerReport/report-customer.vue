              ...
              >
                <template v-slot:title="{ item }">
                  <span v-if="item.key === 'intentionChainRatio'">
                    <span
                      v-if="item.chainRatioRiseOrDecline === 'decline'"
                      style="color: #e50113"
                    >
                      <p-icon
                    ...
                    <span
                      v-else-if="item.chainRatioRiseOrDecline === 'rise'"
                      style="color: #07c160"
                    >
                      <p-icon
                        type="question-circle"
              ...
              >
                <template v-slot:title="{ item }">
                  <span v-if="item.key === 'officialChainRatio'">
                    ...
                    <span
                      v-else-if="item.chainRatioFlag === 'rise'"
                      style="color: #07c160"
                    >
                      <p-icon
                        type="question-circle"
          ...
          <div style="margin-top: 8px">
            ...
            >
              <template v-if="!clientChannelTab">
                <client-channel-new
                  slot="client-channel-new"
                  :reportQuery="reportQuery"
                ></client-channel-new>
                <client-channel-amount
                  slot="client-channel-amount"
                  :reportQuery="reportQuery"
                ></client-channel-amount>
              </template>
              <template v-else>
                <div slot="client-channel-new">
                  <client-channel-new-table
                    :reportQuery="reportQuery"
                  ></client-channel-new-table>
                </div>
                <div slot="client-channel-amount">
                  <client-channel-amount-table
                    :reportQuery="reportQuery"
                  ></client-channel-amount-table>
                </div>
              </template>
          ...
          <div style="margin-top: 8px">
            ...
            >
              <template v-if="!clientBusinessTab">
                <client-business-new
                  slot="client-business-new"
                  :reportQuery="reportQuery"
                ></client-business-new>
                <client-business-amount
                  slot="client-business-amount"
                  :reportQuery="reportQuery"
                ></client-business-amount>
              </template>
              <template v-else>
                <div slot="client-business-new">
                  <client-business-new-table
                    :reportQuery="reportQuery"
                  ></client-business-new-table>
                </div>
                <div slot="client-business-amount">
                  <client-business-amount-table
                    :reportQuery="reportQuery"
                  ></client-business-amount-table>
                </div>
              </template>
          ...
          <div style="margin-top: 8px">
            ...
            <template v-else>
              <div slot="new-customer-business-center">
                <new-customer-business-center-table
                  :reportQuery="reportQuery"
                ></new-customer-business-center-table>
              </div>
            </template>
