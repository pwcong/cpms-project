...
async function createByRouteMode(options) {
  ...
  try {
    ...
    writeCode(path.join(editDir, 'index.vue'), path.join(__dirname, 'tmpl/view_edit.tmpl'), options);
    writeCode(path.join(editDir, 'form.js'), path.join(__dirname, 'tmpl/js_form.tmpl'), options);
    writeCode(path.join(detailDir, 'index.vue'), path.join(__dirname, 'tmpl/view_detail.tmpl'), options);
    writeCode(path.join(listDir, 'index.vue'), path.join(__dirname, 'tmpl/view_list.tmpl'), options);
  } catch (e) {
    console.error(e);
  }
}
...
async function createByModalMode(options) {
  ...
  try {
    ...
    writeCode(path.join(moduleDir, 'index.vue'), path.join(__dirname, 'tmpl/modal_module.tmpl'), options);
    writeCode(path.join(moduleDir, 'setting-item.vue'), path.join(__dirname, 'tmpl/modal_setting.tmpl'), options);
  } catch (e) {
    console.error(e);
  }
}
