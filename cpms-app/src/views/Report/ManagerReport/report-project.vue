          ...
          >
            <template v-slot:title="{ item }">
              ...
              <span v-if="item.key === 'moneyChainRatio'">
                <span v-if="item.moneyRiseOrDecline === 'decline'" style="color: #e50113">
                  <van-icon color="#e50113" name="down" />
                  {{ item.title }}
                </span>
                <span v-else-if="item.moneyRiseOrDecline === 'rise'" style="color: #07c160">
                  <van-icon color="#07c160" name="down" style="transform: rotate(180deg)" />
                  {{ item.title }}
                </span>
                <span v-else>
        ...
        <div style="margin-top: 8px">
          ...
          >
            <template v-if="!clientBusinessTab">
              <project-business-new slot="project-business-new" :reportQuery="reportQuery"></project-business-new>
            ...
            <template v-else>
              <div slot="project-business-new">
                <project-business-new-table :reportQuery="reportQuery"></project-business-new-table>
              </div>
              <div slot="project-business-amount">
                <project-business-amount-table :reportQuery="reportQuery"></project-business-amount-table>
              </div>
            </template>
          </tabs-layout>
        </div>
        ...
        <div style="margin-top: 8px">
          ...
          >
            <template v-if="!clientChannelTab">
              <project-channel-new slot="project-channel-new" :reportQuery="reportQuery"></project-channel-new>
              <project-channel-amount slot="project-channel-amount" :reportQuery="reportQuery"></project-channel-amount>
            </template>
            <template v-else>
              <div slot="project-channel-new">
                <project-channel-new-table :reportQuery="reportQuery"></project-channel-new-table>
              </div>
              <div slot="project-channel-amount">
                <project-channel-amount-table :reportQuery="reportQuery"></project-channel-amount-table>
              </div>
            </template>
          </tabs-layout>
        </div>
        ...
        <div style="margin-top: 8px">
          ...
          <template v-else>
            <div slot="new-project-business-center">
              <new-project-business-center-table :reportQuery="reportQuery"></new-project-business-center-table>
            </div>
          </template>
        </div>
      </block>
    ...
    <block theme="card" style="margin-top: 8px">
      <block>
        ...
        <div style="margin-top: 8px">
          ...
          >
            <template>
              <project-type-new slot="project-type-new" :reportQuery="reportQuery"></project-type-new>
              <project-type-amount slot="project-type-amount" :reportQuery="reportQuery"></project-type-amount>
            </template>
          </tabs-layout>
        </div>
      </block>
    ...
    <block theme="card" style="margin-top: 8px">
      <block>
        ...
        <div style="margin-top: 8px">
          ...
          >
            <template>
              <project-stage-bidding slot="project-stage-bidding" :reportQuery="reportQuery"></project-stage-bidding>
              <project-stage-non-bidding
                slot="project-stage-non-bidding"
                :reportQuery="reportQuery"
              ></project-stage-non-bidding>
              <project-stage-stock-up slot="project-stage-stock-up" :reportQuery="reportQuery"></project-stage-stock-up>
              <project-stage-amount slot="project-stage-amount" :reportQuery="reportQuery"></project-stage-amount>
            </template>
          </tabs-layout>
        </div>
      </block>
