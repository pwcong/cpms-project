  ...
  methods: {
    ...
    async loadProject(id) {
      ...
      let projectProductList = await api.business
        ...
        .then((res) => (res.data || []).filter((d) => d.fdProductCategoryCode !== '完全定制化'));
      ...
      this.formData = {
        ...
        fdCustId:
          projectDetailInfo.fdProjectManner === '代理商操作'
            ? projectDetailInfo.fdTianyanchaMainId
            : projectDetailInfo.fdCustMainId,
        fdCustName:
          projectDetailInfo.fdProjectManner === '代理商操作'
            ? projectDetailInfo.fdTianyanchaName
            : projectDetailInfo.fdCustName,
        // fdTianyanchaMainId:projectDetailInfo.fdTianyanchaMainId,
        // fdTianyanchaName:projectDetailInfo.fdTianyanchaName,
        fdProductLineList: this.getOnlyProductLine(projectDetailInfo.projectProductListDtoList),
        fdCorporateCode: projectDetailInfo.fdCorporateCode,
        fdCorporateName: projectDetailInfo.fdCorporateName,
        // fdProjectManner:projectDetailInfo.fdProjectManner,
      };
    },
