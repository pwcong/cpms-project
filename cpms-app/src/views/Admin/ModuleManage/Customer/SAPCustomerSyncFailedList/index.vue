<template>
  <list-layout class="page-project-query">
    <template v-slot:header="{ className }">
      <van-nav-bar :class="className" title="同步失败客户" left-text="返回" left-arrow @click-left="handleCancel" />
    </template>
    ...
    <error-repair-filter v-model="query.filter" :visible.sync="showFilter" />
  </list-layout>
</template>
...
import ErrorRepairFilter, { convertFilter2Query } from '../../components/filter/error-repair-list';

import ErrorRepairItem from './item';
