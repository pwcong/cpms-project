<template>
  <list-layout class="page-customer-list">
    <template v-slot:header="{ className }">
      <van-nav-bar :class="className" title="意向客户列表" left-text="返回" left-arrow @click-left="handleCancel" />
    </template>
...
import PageFilter, { convertFilter2Query } from '../../../../Customer/components/filter/index';
