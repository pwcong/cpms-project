...
export function getProjectComponentProcessType(query) {
  return get('/api/cpms/projectComponentConfig/getProcessType', query).then((res) => res.data || {});
}
...
export function getProjectComponentType(query) {
  return get('/api/cpms/projectComponentConfig/getComponentType', query).then((res) => res.data || {});
}
...
export function postProjectStageComponentForm(form) {
  return post('/api/cpms/projectStageComponentConfig', form).then((res) => res.data || {});
}
...
export function delProjectStageComponent(ids) {
  return del(`/api/cpms/projectStageComponentConfig/${ids}`, {}).then((res) => res.data || {});
}
...
export function getProjectReport(query) {
  return get('/api/cpms/projectMain/getProjectReport', query).then((res) => res.data || {});
}
...
export function putProjectStakeholderInvalid(ids) {
  return put(`/api/cpms/projectStakeholderList/invalid/${ids}`, {}).then((res) => res.data || {});
}
...
export function putProjectAddressInvalid(ids) {
  return put(`/api/cpms/projectAddressList/invalid/${ids}`, {}).then((res) => res.data || {});
}
...
export function putProjectChangeStageForm(form) {
  return put(`/api/cpms/projectStageList/changeStage`, form).then((res) => res.data || {});
}

/** 推进到下一阶段 */
export function postProjectChangeStage(form) {
  return post(`/api/cpms/projectStageList/propelNextStage`, form).then((res) => res.data || {});
}
...
export function postChangeProjectManager(form) {
  return post(`/api/cpms/projectMain/changeProjectManager`, form).then((res) => res.data || {});
}
...
export function getComponentInfoList(query) {
  return post(`/api/cpms/projectStageList/getComponentInfoList`, query).then((res) => res.data || {});
}
...
export function getProjectStatus(query) {
  return get(`/api/cpms/projectMain/getProjectStatus`, query).then((res) => res.data || {});
}
...
export function getBusinessCenter() {
  return get(`/api/cpms/projectMain/get-business-center`, {}).then((res) => res.data || {});
}
